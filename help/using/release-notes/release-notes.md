...
**區段資格**&#x200B;活動不再可用於包含Campaign Standard訊息活動的歷程中。 此限制可保護Adobe Campaign Standard執行個體的完整性。 事實上，使用區段資格可能會導致訊息傳送的每日高峰，而且會使Campaign Standard交易式訊息過載。 [閱讀全文](../about/limitations.md#segment-qualification)
