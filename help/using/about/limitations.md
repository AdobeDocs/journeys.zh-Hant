...
* 對於特定執行個體，Adobe Campaign Standard交易式訊息每小時最大規模為50,000則訊息。 另請參閱 [Adobe Campaign Standard產品說明](https://helpx.adobe.com/legal/product-descriptions/campaign-standard.html). 
 
## 事件限制
