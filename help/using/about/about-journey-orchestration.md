...
* 您在歷程設計程式中善用的其他自訂資料來源。 自訂資料來源是指透過 API 在 [!DNL Journey Orchestration] 和第三方系統或服務之間的連線。 您可以連線第三方系統，例如忠誠度系統。 例如，第三方服務可以是氣象 API。
...
之後，您可以使用動作活動，透過第三方系統傳送訊息。 如果您擁有 Adobe Campaign Standard，請傳送即時個人化簡訊、推播通知或電子郵件。
