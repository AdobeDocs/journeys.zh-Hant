...
+ 從 [!DNL Journey Orchestration] 開始 {#starting-with-journeys}
   ...
   + [存取權管理](using/about/access-management.md)
...
+ 建立歷程 {#building-journeys}
   + 關於歷程建立 {#about-journey-building}
      ...
      + [測試輪廓](using/building-journeys/creating-test-profiles.md)
   + 活動 {#about-journey-building}
      + 事件活動 {#events-activities}
         ...
         + [細分資格篩選事件](using/building-journeys/segment-qualification-events.md)
...
+ 建立運算式 {#building-advanced-conditions-journeys}
   + [概觀](using/expression/expressionadvanced.md)
   + 語法 {#syntax}
